...
:- dynamic(clue/4).
clue(1, sadies_sob_story, "She met George at the New York Public Library. She loves George because she found him entirely different from your ordinary Joe. He read books about the human brain and the spirit world and all kinds of things. He thought a lot. George would have gone to college, only his family couldn’t afford it.", false).
clue(2, sadies_sob_story, "[Core, Fuller’s Electrical Repair] George works as an electrical repairman at Fuller’s Electrical Repair, just a couple blocks north of Fulton Street in downtown Brooklyn.", false).
clue(3, sadies_sob_story, "Sadie admits she doesn’t see George every night, which the police took to mean he two- times her. They just don’t understand George. Someday you’ll hear about him as a famous inventor. At night, he works on building his machine and Mr. Fuller lets him use the workbench. Some nights, he comes by her place but others he works so late that he just sleeps at the shop. She mostly sees him on weekends.", false).
